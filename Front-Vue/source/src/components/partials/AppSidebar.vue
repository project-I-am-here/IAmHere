...
<!--              <p class="name">Edson Rodrigues</p>-->
...
<!--        </li>-->
        ...
        <li class="nav-item"><router-link class="nav-link" to="/patient/"><img class="menu-icon" src="../../assets/images/menu_icons/02.png" alt="menu icon"><span class="menu-title">Pacientes</span></router-link></li>
        <li class="nav-item"><router-link class="nav-link" to="/schedule/"><img class="menu-icon" src="../../assets/images/menu_icons/02.png" alt="menu icon"><span class="menu-title">Agenda</span></router-link></li>
        <li class="nav-item">
          <span class="nav-link" v-b-toggle="'clinica'">
            <img class="menu-icon" src="../../assets/images/menu_icons/08.png" alt="menu icon"><span class="menu-title">Clinica</span><i class="menu-arrow"></i>
          </span>
          <b-collapse id="clinica">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"><router-link class="nav-link" to="/clinic/">Dados</router-link></li>
              <li class="nav-item"><router-link class="nav-link" to="/professional/">Profissionais</router-link></li>
            </ul>
          </b-collapse>
        </li>
        ...
        <li class="nav-item">
          <span class="nav-link" v-b-toggle="'sample-pages1'">
            <img class="menu-icon" src="../../assets/images/menu_icons/08.png" alt="menu icon"><span class="menu-title">Iten de Layout</span><i class="menu-arrow"></i>
          </span>
          <b-collapse id="sample-pages1">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"><router-link class="nav-link" to="/tabs/">Users</router-link></li>
